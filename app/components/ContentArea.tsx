      ...
      <div className="max-w-4xl mx-auto p-4 md:p-8">
        ...
        <div className="prose prose-invert prose-green max-w-none">
          <ReactMarkdown
            ...
            components={{
              h1: ({node, ...props}) => <h1 className="text-xl md:text-2xl font-bold text-terminal-green mb-4 mt-6 font-mono" {...props} />,
              h2: ({node, ...props}) => <h2 className="text-lg md:text-xl font-bold text-terminal-amber mb-3 mt-5 font-mono" {...props} />,
              h3: ({node, ...props}) => <h3 className="text-base md:text-lg font-bold text-terminal-text mb-2 mt-4 font-mono" {...props} />,
              p: ({node, ...props}) => <p className="mb-4 leading-relaxed text-terminal-text text-sm md:text-base" {...props} />,
              ul: ({node, ...props}) => <ul className="list-disc list-inside mb-4 space-y-2 text-terminal-text text-sm md:text-base" {...props} />,
              ol: ({node, ...props}) => <ol className="list-decimal list-inside mb-4 space-y-2 text-terminal-text text-sm md:text-base" {...props} />,
              ...
              blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-terminal-green pl-4 italic text-terminal-dim my-4 text-sm md:text-base" {...props} />,
              a: ({node, ...props}) => <a className="text-terminal-green hover:text-terminal-amber underline transition-colors break-words" {...props} />,
              table: ({node, ...props}) => <div className="overflow-x-auto my-4 -mx-4 md:mx-0"><table className="min-w-full border border-terminal-border text-sm" {...props} /></div>,
              th: ({node, ...props}) => <th className="border border-terminal-border px-3 py-2 bg-terminal-surface text-terminal-amber font-bold whitespace-nowrap" {...props} />,
              td: ({node, ...props}) => <td className="border border-terminal-border px-3 py-2 text-sm" {...props} />,
